...
The shape bias is seen as a flexible and controlled process, governed by general world knowledge and conceptual understanding [@BOOTH2002B11; @2005_Booth].
...
```{r prisma , fig.height = 2.5, fig.width =2.5, out.width="100%", fig.cap="A diagram to visualize different factors that potentially contribute to the origin of the shape bias and theoretical framworks that find them."}
