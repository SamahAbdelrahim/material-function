...
A within subject manipulation with two conditions: material or function. The material condition is identical to the first experiment. In the function condition, the experimenter introduces the exemplar object ("this is a gorp"), gives the child 15 seconds seconds to play with it, provides functional information ("the gorp grabs toys"), gives another 15 seconds to play with it, and puts the toy away within the child's view. They then introduce the test objects as in Experiment 1 and ask for a response. The order of conditions was counterbalanced. 
